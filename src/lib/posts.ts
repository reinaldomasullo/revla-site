...
export const posts: Post[] = [
  ...
  },
  {
    ...
    title:
      "Seguro RC Profissional: o que é, quem precisa e como funciona a cobertura",
    description:
      "Entenda o que é o seguro RC Profissional, quais profissões costumam contratar, o que a cobertura inclui e como escolher a apólice certa com uma corretora.",
    category: "Seguros",
    date: "2026-08-13",
    coverImage: {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "A Revla é corretora de seguros registrada na SUSEP e compara apólices de seguradoras parceiras, como Porto Seguro, Icatu, MAG Mongeral, AZOS, PASI e Tokio Marine. A contratação e a análise do risco são sempre feitas pela seguradora escolhida.",
      },
    ],
  },
  {
    ...
    description:
      "Seguro auto vale a pena? Entenda os fatores que definem o preço, a diferença entre compreensivo e RCF-V e como calcular se compensa no seu caso.",
    category: "Seguros",
    date: "2026-08-13",
    coverImage: {
    ...
    faq: [
      {
        ...
        answer:
          "Não. O seguro auto é opcional — o que existe hoje é o DPVAT extinto e, em alguns estados, cobrança vinculada ao licenciamento. O seguro compreensivo ou RCF-V só é exigido quando o carro é financiado, por condição contratual do banco ou financeira.",
      },
      {
        question: "Qual a diferença entre seguro compreensivo e RCF-V?",
        answer:
          "O compreensivo cobre o seu próprio carro (colisão, roubo, incêndio) além de danos a terceiros. O RCF-V cobre apenas danos que você causar a terceiros — materiais, corporais ou morais — sem reparar o seu veículo. É uma opção mais barata para quem só quer se proteger de indenizações a outras pessoas.",
      },
      {
        question: "Franquia mais alta sempre é a melhor escolha?",
        answer:
          "Não necessariamente. Franquia mais alta reduz o prêmio mensal, mas aumenta o valor que você paga do próprio bolso em caso de sinistro. A escolha ideal depende de quanto você teria disponível para pagar essa franquia sem comprometer outras contas no momento do acidente.",
      },
      {
        question: "O que mais pesa no preço do seguro do meu carro?",
        answer:
          "Perfil do condutor (idade, tempo de habilitação, histórico de sinistros), características do veículo (modelo, ano, valor, itens de segurança), região de circulação e as coberturas e franquia escolhidas. A combinação dessas variáveis explica por que cotações variam tanto entre pessoas diferentes.",
      },
      {
        question: "Vale a pena contratar só o RCF-V em vez do seguro completo?",
        answer:
          "Pode valer para carros antigos ou de baixo valor de mercado, quando o dono tem reserva financeira para repor o veículo sozinho, mas quer se proteger do risco mais alto: uma indenização grande a terceiros. Para carros financiados ou de valor relevante, o compreensivo costuma ser mais indicado.",
      },
    ],
  },
  {
    ...
    description:
      "Entenda o que é planejamento patrimonial, por que não é só para quem já é rico e como consórcio, seguro e plano de saúde protegem sua família e seus bens.",
    category: "Planejamento Patrimonial",
    date: "2026-08-13",
    updated: "2026-09-14",
    coverImage: {
  ...
  },
  {
    ...
    description:
      "Planejamento patrimonial não exige fortuna: veja pilares práticos, um passo a passo simples e como consórcio, seguro e plano de saúde protegem seu patrimônio.",
    category: "Planejamento Patrimonial",
    date: "2026-08-13",
    coverImage: {
    ...
    faq: [
      {
        question:
          "Preciso ter um patrimônio grande para começar a fazer planejamento patrimonial?",
        answer:
  ...
  },
  {
    ...
    description:
      "Entenda como o seguro protege seu patrimônio contra imprevistos e como ele se encaixa em uma estratégia de planejamento patrimonial responsável.",
    category: "Planejamento Patrimonial",
    date: "2026-08-13",
    coverImage: {
    ...
    faq: [
      {
        question:
          "Seguro faz parte de planejamento patrimonial ou é algo separado?",
        answer:
          "Seguro é uma das ferramentas centrais do planejamento patrimonial, ao lado de instrumentos como o consórcio. Enquanto outras estratégias ajudam a formar e organizar bens, o seguro protege o que já foi construído contra eventos que poderiam destruí-lo de uma só vez. Por isso costuma ser tratado como base, e não como item opcional.",
      },
      {
        question: "Qual seguro contratar primeiro para proteger a família?",
        answer:
          "Não existe uma resposta única, mas seguro de vida e plano de saúde costumam ser prioridade para quem tem dependentes financeiros, já que cobrem os dois eventos com maior potencial de comprometer o patrimônio de forma repentina. Depois entram seguro residencial e, se aplicável, seguro empresarial. A ordem ideal depende da composição do patrimônio e dos riscos de cada família.",
      },
      {
        question:
          "A Revla Corretora administra investimentos ou faz planejamento sucessório?",
        answer:
      ...
      },
      {
        ...
        answer:
          "Sim. Mudanças como aumento de renda, compra de bens, nascimento de filhos ou abertura de um negócio alteram o valor do patrimônio a proteger. Revisar as apólices periodicamente evita que a cobertura fique defasada em relação ao risco real, seja para mais ou para menos.",
      },
      {
        question:
          "Seguro substitui a necessidade de uma reserva de emergência?",
        answer:
  ...
  },
  {
    ...
    description:
      "Os erros mais comuns de quem não faz planejamento patrimonial: falta de seguro, plano de saúde e organização de bens. Veja como evitar cada um.",
    category: "Planejamento Patrimonial",
    date: "2026-08-13",
    coverImage: {
    ...
    faq: [
      ...
      {
        question:
          "Qual é o erro mais comum em planejamento patrimonial no Brasil?",
        answer:
          "O erro mais frequente é não ter seguro de vida nem seguro patrimonial, deixando a família sem proteção imediata de renda em caso de morte ou invalidez do provedor. Esse erro costuma ser mais caro que os demais porque afeta diretamente a capacidade da família de manter despesas básicas logo após o imprevisto.",
      },
      {
        question: "Consórcio faz parte de planejamento patrimonial?",
        answer:
          "Sim, quando usado como ferramenta de aquisição planejada de bens, como imóvel ou veículo, sem recorrer a financiamento com juros altos. Um consórcio bem dimensionado ajuda a família a crescer o patrimônio de forma organizada, mas não substitui seguro nem plano de saúde, que cobrem riscos diferentes.",
      },
      {
  ...
  },
  {
    ...
    description:
      "Entenda o que o seguro residencial cobre, as principais exclusões e os fatores que realmente definem o preço da apólice no Brasil, segundo a SUSEP.",
    category: "Seguros",
    date: "2026-08-13",
    coverImage: {
  ...
  },
  {
    ...
    description:
      "Entenda o que é seguro empresarial, quais riscos ele cobre, quem deve contratar e como escolher a apólice certa para proteger sua empresa.",
    category: "Seguros",
    date: "2026-08-13",
    coverImage: {
    ...
    faq: [
      {
        ...
        answer:
          "Não existe uma lei federal que obrigue toda empresa a ter seguro empresarial. No entanto, contratos de aluguel comercial, editais de licitação e algumas atividades regulamentadas costumam exigir apólices específicas, como responsabilidade civil, como condição para operar ou fechar negócio.",
      },
      {
        question:
          "Qual a diferença entre seguro empresarial e seguro patrimonial?",
        answer:
          "Seguro patrimonial é uma das coberturas dentro do seguro empresarial, focada em proteger o imóvel, os móveis e os equipamentos contra incêndio, roubo e outros danos físicos. O seguro empresarial é mais amplo e pode incluir também responsabilidade civil, lucros cessantes e despesas fixas, entre outras coberturas.",
      },
      {
        question: "Quanto custa um seguro empresarial?",
        answer:
          "O valor varia conforme o setor de atividade, a localização, o valor do patrimônio segurado e as coberturas escolhidas, por isso não há um preço único de mercado. O caminho mais confiável é solicitar uma cotação personalizada com base no perfil real do negócio junto a uma corretora registrada na SUSEP.",
      },
      {
        question: "O seguro empresarial cobre prejuízo por parada de produção?",
        answer:
          "Sim, desde que a apólice inclua a cobertura de lucros cessantes, que repõe a receita que a empresa deixaria de faturar enquanto está impedida de operar por um sinistro coberto, como incêndio ou dano elétrico grave. Essa cobertura costuma ser contratada junto com a de despesas fixas, para cobrir compromissos como aluguel e salários durante a paralisação.",
      },
      {
        question:
          "Pequenas empresas e MEIs podem contratar seguro empresarial?",
        answer:
          "Sim, existem apólices empresariais adaptadas para pequenos negócios e microempreendedores, com coberturas básicas de incêndio, roubo e responsabilidade civil a um custo compatível com o porte da operação. O ideal é avaliar os riscos específicos da atividade antes de escolher entre um plano simplificado e uma apólice mais completa.",
      },
    ],
  },
  {
    ...
    description:
      "Entenda como funciona o consórcio, compare com financiamento e descubra quando essa modalidade sem juros compensa mais para comprar seu bem.",
    category: "Consórcios",
    date: "2026-08-13",
    updated: "2026-09-14",
    coverImage: {
  ...
  },
  {
    ...
    description:
      "Entenda como funciona o consórcio de imóveis, suas vantagens, os tipos de lance e como acelerar a contemplação com a ajuda de uma consultoria especializada.",
    category: "Consórcios",
    date: "2026-08-13",
    coverImage: {
  ...
  },
  {
    ...
    description:
      "Entenda como funciona o consórcio de veículos, sem juros, com parcelas menores e lance embutido. Veja vantagens, riscos e como contemplar seu carro.",
    category: "Consórcios",
    date: "2026-08-13",
    coverImage: {
  ...
  },
  {
    ...
    title:
      "Lance no consórcio: o que é, tipos e como usar para antecipar a contemplação",
    description:
      "Entenda o que é lance no consórcio, os tipos (livre, fixo, embutido), estratégias de uso e os erros mais comuns na hora de antecipar a contemplação.",
    category: "Consórcios",
    date: "2026-08-13",
    coverImage: {
    ...
    faq: [
      {
        ...
        answer:
          "Não. O lance aumenta a chance de contemplação, mas ela só ocorre se o seu valor for o vencedor entre os participantes que ofertaram naquela assembleia. Se houver lances maiores, o consorciado continua no grupo aguardando sorteio ou uma próxima disputa por lance.",
      },
      {
        question: "Qual a diferença entre lance livre e lance embutido?",
        answer:
          "No lance livre, o consorciado oferece recursos próprios, sem usar parte da carta de crédito. No lance embutido, uma parcela do próprio crédito é utilizada como oferta, reduzindo o valor final disponível para a compra do bem ou serviço, mas sem exigir dinheiro extra do bolso.",
      },
      {
        question: "Posso usar o FGTS como lance no consórcio?",
        answer:
          "Sim, mas apenas em consórcios de imóveis e seguindo as regras do FGTS para essa finalidade. O saldo pode ser usado total ou parcialmente como lance, desde que o consorciado atenda aos critérios estabelecidos pela Caixa Econômica Federal e pela administradora do consórcio.",
      },
      {
        question: "O que acontece se eu der lance e não for contemplado?",
        answer:
          "Nada é perdido: se o lance foi feito com recursos próprios, o valor ofertado costuma ser devolvido ou reaproveitado conforme as regras do grupo (por exemplo, permanecendo como crédito para novas tentativas). Se foi lance embutido, como não houve desembolso adicional, o consorciado simplesmente continua pagando as parcelas normalmente até a próxima assembleia.",
      },
      {
        question: "Consórcio com lance é uma forma de investimento?",
        answer:
          "Não. O consórcio é uma modalidade de autofinanciamento coletivo para aquisição de bens e serviços, regulada pelo Banco Central, e não promete rentabilidade nem retorno financeiro. O lance é apenas um mecanismo para antecipar a contemplação dentro desse sistema, não uma estratégia de investimento.",
      },
    ],
  },
  {
    ...
    description:
      "Consórcio é seguro quando a administradora é autorizada pelo Banco Central. Veja como verificar isso, evitar golpes e escolher a administradora certa.",
    category: "Consórcios",
    date: "2026-08-13",
    coverImage: {
  ...
  },
  {
    ...
    description:
      "Saiba o que avaliar antes de contratar plano de saúde para idosos: rede credenciada, carência, reajuste por faixa etária e coparticipação, com dicas práticas.",
  ...
  },
  {
    ...
    description:
      "Veja os prazos legais de carência em plano de saúde: urgência, doenças preexistentes, Cobertura Parcial Temporária e como a portabilidade reduz a espera.",
    category: "Plano de Saúde",
    date: "2026-08-13",
    coverImage: {
    ...
    faq: [
      {
        ...
        answer:
          "Depende do tipo de procedimento. A lei permite até 24 horas para urgência e emergência, até 180 dias para consultas, exames e demais procedimentos, até 300 dias para partos a termo e até 24 meses para a Cobertura Parcial Temporária de doenças preexistentes. A operadora pode praticar prazos menores, mas nunca pode ultrapassar esses limites.",
      },
      {
        question: "Existe carência para atendimento de urgência e emergência?",
        answer:
          "Sim, mas o prazo máximo é de apenas 24 horas após o início do contrato. Passado esse período, o atendimento de urgência é garantido, embora procedimentos de maior complexidade decorrentes desse atendimento possam ainda depender do cumprimento da carência geral de 180 dias, dependendo da situação.",
      },
      {
        question:
          "O que é Cobertura Parcial Temporária e quando ela se aplica?",
        answer:
          "A Cobertura Parcial Temporária, ou CPT, é aplicada quando o beneficiário declara ter uma doença ou lesão preexistente na contratação. Ela suspende, por até 24 meses, a cobertura de procedimentos de alta complexidade, leitos de alta tecnologia e cirurgias relacionados a essa condição específica, mantendo o restante do atendimento coberto normalmente.",
      },
      {
        question:
          "Como funciona a portabilidade de carências e ela realmente evita nova carência?",
        answer:
          "A portabilidade de carências permite trocar de plano de saúde sem cumprir novos períodos de carência, desde que o beneficiário atenda a requisitos como contrato ativo, mensalidades em dia e tempo mínimo de permanência no plano de origem. O processo é feito por meio do Buscador de Planos da ANS, que verifica a compatibilidade entre o plano atual e o pretendido antes de autorizar a mudança.",
      },
      {
        question:
          "Idosos pagam ou cumprem carência maior do que outras pessoas?",
        answer:
          "Os prazos máximos de carência previstos em lei são os mesmos para qualquer idade. A diferença prática para idosos é que, por terem maior probabilidade de já possuir alguma condição de saúde preexistente, ficam mais sujeitos à aplicação da Cobertura Parcial Temporária, o que exige atenção redobrada na hora de declarar a saúde e de avaliar alternativas como o Agravo ou a portabilidade.",
      },
    ],
  },
  {
    ...
    description:
      "Entenda quando plano de saúde compensa mais que pagar particular na terceira idade, com regras da ANS, prós e contras de cada opção e fatores para decidir.",
    category: "Plano de Saúde",
    date: "2026-08-13",
    coverImage: {
    ...
    faq: [
      ...
      {
        question:
          "É mais barato ter plano de saúde ou pagar particular na terceira idade?",
        answer:
      ...
      },
      {
        ...
        answer:
          "Sim, é possível contratar um plano de saúde em qualquer idade, mas o valor da mensalidade tende a ser mais alto porque a pessoa já entra em uma das últimas faixas etárias. Também é comum haver carências e, em alguns casos, cobertura parcial temporária para doenças preexistentes, conforme as regras da operadora.",
      },
      {
        question:
          "O que acontece se eu ficar sem plano de saúde por um tempo e depois quiser contratar de novo?",
        answer:
          "Ao contratar um novo plano após um período sem cobertura, o beneficiário geralmente precisa cumprir novos prazos de carência, mesmo já tendo tido plano anteriormente. Por isso, interromper a cobertura por economia no curto prazo pode gerar custos e riscos maiores no médio prazo, especialmente na terceira idade.",
      },
      {
        question:
          "Existe alguma alternativa entre plano de saúde completo e pagar tudo particular?",
        answer:
          "Sim, planos com coparticipação são uma opção intermediária: a mensalidade costuma ser menor, mas o beneficiário paga uma parte do custo cada vez que usa consultas, exames ou procedimentos. Essa modalidade pode fazer sentido para quem quer reduzir o custo fixo mensal sem abrir mão completamente da rede credenciada e da proteção contra eventos de alto custo.",
      },
    ],
  },
  {
    ...
    description:
      "Entenda a portabilidade de carências da ANS e como pessoas com 60+ podem trocar de plano de saúde sem recomeçar prazos: requisitos e passo a passo.",
    category: "Plano de Saúde",
    date: "2026-08-13",
    coverImage: {
  ...
  },
  {
    ...
    description:
      "Entenda quando o plano de saúde cobre home care na terceira idade, o que costuma estar incluso e quais perguntas fazer à operadora antes de contratar.",
    category: "Plano de Saúde",
    date: "2026-08-13",
    coverImage: {
...

  {
    ...
    description:
      "Entenda o que é amparo funeral, quais coberturas inclui e como a assistência à família funciona nos momentos mais difíceis. Guia completo e sem rodeios.",
    date: "2026-08-13",
    updated: "2026-09-14",
    ...
    faq: [
      {
        question:
          "Amparo funeral é a mesma coisa que plano funerário tradicional?",
        answer:
          "Não exatamente. O plano funerário tradicional costuma ser contratado diretamente com funerárias e foca apenas nos serviços do velório. O amparo funeral, oferecido por seguradoras ou corretoras, geralmente inclui também assistência 24 horas, suporte à família e, em alguns casos, cobertura para dependentes dentro de um único contrato.",
      },
      {
        question:
          "O amparo funeral cobre despesas de translado do corpo para outra cidade?",
        answer:
          "Sim, na maioria dos planos, mas dentro de limites de distância e valor definidos na apólice. É importante verificar essas condições antes de contratar, já que elas variam conforme a modalidade escolhida e a seguradora responsável.",
      },
      {
        question:
          "Qual a diferença entre amparo funeral individual, familiar e sênior?",
        answer:
          "O individual cobre apenas o titular do plano. O familiar estende a cobertura a cônjuge, filhos e outros dependentes declarados na contratação. Já o sênior é voltado a pessoas acima de 75 anos, com condições específicas pensadas para essa faixa etária.",
      },
      {
        question: "É preciso ter seguro de vida além do amparo funeral?",
        answer:
          "Não é obrigatório, mas os dois produtos cumprem funções diferentes. O seguro de vida costuma pagar uma indenização em dinheiro aos beneficiários, enquanto o amparo funeral entrega principalmente um serviço de assistência funerária. Muitas famílias optam por ter as duas proteções para cobrir tanto a parte financeira quanto a operacional.",
      },
      {
        question:
          "Como funciona o acionamento da assistência à família em caso de óbito?",
        answer:
          "Basta entrar em contato com a central de atendimento 24 horas informando o falecimento e os dados do titular ou dependente coberto. A partir daí, a equipe de assistência orienta sobre documentos necessários e organiza os serviços de funeral dentro dos limites previstos na apólice.",
      },
    ],
  },
  {
    ...
    description:
      "Entenda o que muda na contratação do amparo funeral sênior após os 75 anos, quais condições as seguradoras avaliam e como escolher a modalidade certa.",
    date: "2026-08-13",
    category: "Amparo Funeral",
    coverImage: {
  ...
  },
  {
    ...
    title:
      "Amparo funeral vale a pena? Entenda os custos de um funeral e como se planejar",
    description:
      "Descubra se o amparo funeral vale a pena, quais custos compõem um funeral no Brasil e como se planejar para proteger sua família desse imprevisto.",
    date: "2026-08-13",
    category: "Amparo Funeral",
    coverImage: {
    ...
    faq: [
      {
        ...
        answer:
          "São produtos com a mesma finalidade prática — cobrir despesas e organizar a logística de um funeral —, mas podem ter estruturas contratuais diferentes conforme a seguradora ou prestadora. O importante é verificar quais coberturas estão incluídas, como assistência 24h e traslado do corpo, e se a empresa é regulada pela SUSEP. A Revla explica essas diferenças na página de [amparo funeral](/plano-funerario).",
      },
      {
        question: "Quanto custa contratar um amparo funeral?",
        answer:
          "O valor varia conforme a modalidade escolhida (individual, familiar ou sênior), a idade dos incluídos e o nível de cobertura contratado. Por isso, o ideal é solicitar uma simulação personalizada em vez de considerar um valor fixo, já que cada família tem uma composição e uma necessidade diferente.",
      },
      {
        question: "O amparo funeral cobre traslado do corpo para outra cidade?",
        answer:
          "Sim, o traslado do corpo costuma estar entre as coberturas do amparo funeral, especialmente relevante para famílias que moram em cidades diferentes. Essa é justamente uma das situações em que os custos tendem a surpreender quem não tem esse tipo de proteção contratada.",
      },
      {
        question: "Existe carência para usar o amparo funeral?",
        answer:
          "A maioria dos planos de amparo funeral tem um período de carência entre a contratação e a possibilidade de uso da cobertura, o que reforça a importância de contratar com antecedência, e não apenas quando a necessidade já está próxima. Os prazos específicos variam conforme o plano e devem ser confirmados no momento da contratação.",
      },
      {
        question:
          "Qual a diferença entre o amparo funeral sênior e o individual?",
        answer:
          "O amparo funeral sênior é voltado para pessoas acima de 75 anos, faixa etária em que muitos planos tradicionais já não aceitam novas adesões ou aplicam condições muito restritivas. Já o individual atende pessoas fora dessa faixa etária específica, com regras de contratação mais amplas.",
      },
    ],
  },
  {
    ...
    title:
      "Diferença entre amparo funeral, seguro de vida e plano funerário tradicional",
    description:
      "Entenda as diferenças entre amparo funeral, seguro de vida e plano funerário tradicional: regulação, cobertura, portabilidade e quando cada opção faz sentido.",
    date: "2026-08-13",
    category: "Amparo Funeral",
    coverImage: {
    ...
    faq: [
      {
        question:
          "Amparo funeral e plano funerário tradicional são a mesma coisa?",
        answer:
          "Não. O amparo funeral é um produto de seguro, regulado pela SUSEP, com regras padronizadas de transparência, carência e reajuste. O plano funerário tradicional é um contrato de prestação de serviços firmado diretamente com uma funerária, fora do sistema de seguros, seguindo apenas as normas gerais do Código de Defesa do Consumidor.",
      },
      {
        question:
          "É necessário contratar seguro de vida e amparo funeral ao mesmo tempo?",
        answer:
          "Não é obrigatório, mas os dois produtos cobrem necessidades diferentes e podem se complementar. O amparo funeral resolve a organização e o custo imediato do velório, enquanto o seguro de vida garante uma reserva financeira de uso livre para a família no médio e longo prazo.",
      },
      {
        question: "O seguro de vida cobre as despesas do funeral?",
        answer:
          "O valor da indenização pode ser usado para qualquer finalidade, incluindo despesas funerárias, mas o pagamento depende do processo de regulação de sinistro, que não é instantâneo. Por isso, muitas famílias preferem ter também um amparo funeral, com assistência mais imediata para o velório.",
      },
      {
        question:
          "O amparo funeral sênior tem limite de idade para contratação?",
        answer:
          "Geralmente existe uma idade máxima de entrada, mas ela costuma ser mais alta do que a praticada em seguros de vida tradicionais, já que o produto foi desenhado para esse público. As condições de idade, carência e valores variam conforme a seguradora.",
      },
      {
  ...
  },
  {
    ...
    title:
      "Como funciona o traslado e a assistência 24 horas no amparo funeral",
    description:
      "Entenda como funciona o traslado do corpo e a assistência 24 horas no amparo funeral: etapas, documentos, o que costuma ser coberto e como acionar o serviço.",
    date: "2026-08-13",
    category: "Amparo Funeral",
    coverImage: {
    ...
    faq: [
      {
        question:
          "O traslado do corpo está incluído em todas as modalidades de amparo funeral da Revla?",
        answer:
          "Sim, o traslado e a assistência 24 horas fazem parte da estrutura das modalidades individual, familiar e sênior, sempre dentro dos limites previstos em cada apólice. As condições específicas de cobertura devem ser conferidas no contrato de cada plano, já que podem variar conforme a modalidade escolhida.",
      },
      {
        question:
          "Como a família aciona a assistência 24 horas em caso de óbito?",
        answer:
          "Basta ligar para a central de atendimento indicada na apólice, informando os dados do beneficiário e o local onde ocorreu o óbito. A central orienta os próximos passos, incluindo documentação necessária e acionamento da funerária credenciada, funcionando em qualquer dia e horário.",
      },
      {
        question: "Existe limite de distância para o traslado ser realizado?",
        answer:
          "Sim, cada apólice define seus próprios limites de distância e condições para o traslado, por isso é importante consultar o contrato específico contratado com a Revla. Em termos gerais, o serviço cobre o transporte do corpo dentro dos limites previstos na apólice, podendo incluir trajetos terrestres e aéreos conforme a situação.",
      },
      {
  ...
  },
  {
    ...
    description:
      "Veja como usar o FGTS para dar lance no consórcio de imóvel: quem tem direito, requisitos do imóvel e o passo a passo para não travar o pedido na Caixa.",
    category: "Consórcios",
    date: "2026-09-14",
    updated: "2026-09-14",
    coverImage: {
  ...
  },
  {
    ...
    description:
      "Entenda o que o seguro de moto costuma cobrir, o que fica de fora e os fatores que mais pesam no preço da apólice, segundo a SUSEP.",
    category: "Seguros",
    date: "2026-09-15",
    coverImage: {
    ...
    faq: [
      {
        ...
        answer:
          "Sim, mas geralmente como cobertura opcional à parte — acessórios e equipamentos instalados na moto podem ser incluídos na apólice, normalmente com um limite de indenização específico. É importante declarar todos os itens instalados no momento da contratação.",
      },
      {
        question:
          "Preciso declarar se uso a moto para trabalhar como entregador?",
        answer:
          "Sim. Usar a moto pra motofrete ou aplicativos de entrega sem declarar esse uso na contratação pode levar à negativa de cobertura em caso de sinistro durante essa atividade — o uso profissional costuma exigir uma modalidade de apólice específica.",
      },
      {
        question: "O seguro de moto cobre o passageiro da garupa?",
        answer:
          "Não automaticamente. A cobertura para quem anda na garupa costuma ser uma cobertura opcional chamada Acidentes Pessoais de Passageiros (APP), contratada à parte da cobertura básica da moto.",
      },
      {
        question: "Moto muito roubada na região custa mais caro no seguro?",
        answer:
          "Sim. A região de circulação, incluindo o histórico de roubo e furto por CEP, é um dos fatores que a seguradora usa pra calcular o risco e, consequentemente, o valor do prêmio — mesmo que o modelo da moto seja o mesmo em outra região.",
      },
      {
        question: "Posso contratar seguro de moto financiada?",
        answer:
          "Sim, e em muitos financiamentos de motocicleta o seguro é oferecido (ou exigido) já na hora da compra. Vale comparar essa oferta com outras seguradoras antes de aceitar automaticamente a opção oferecida pela financeira, já que as condições podem variar bastante.",
      },
    ],
  },
  {
    slug: "emprestimo-com-garantia-de-imovel-como-funciona",
    title:
      "Empréstimo com garantia de imóvel: como funciona e quando vale a pena",
    description:
      "Entenda como funciona o empréstimo com garantia de imóvel (home equity): taxas, prazos, o que acontece se as parcelas atrasarem e quando essa opção vale mais a pena que um empréstimo comum.",
    category: "Consórcios",
    date: "2026-09-16",
    coverImage: {
      src: "/images/blog/emprestimo-com-garantia-de-imovel-como-funciona-capa.jpg",
      alt: "Chaveiro em formato de casa ao lado de miniaturas de casas sobre uma mesa, representando o empréstimo com garantia de imóvel",
      width: 1200,
      height: 630,
    },
    content: [
      ...
      {
        type: "p",
        text: "Já para quem precisa de um valor pequeno, tem urgência incompatível com o prazo de avaliação do imóvel, ou não tem uma fonte de renda estável para garantir o pagamento das parcelas, outras opções de crédito ou o [consórcio](/consorcios) — que não cobra juros, mas depende de contemplação — podem se encaixar melhor.",
      },
      {
        type: "h2",
        id: "como-contratar-com-a-revla",
        text: "Como contratar o empréstimo com garantia de imóvel com a Revla",
      },
      {
        type: "p",
        text: "A Revla intermedia o empréstimo com garantia de imóvel em parceria com instituições financeiras autorizadas, como a Ademicon, buscando as condições mais vantajosas conforme o perfil do cliente e o imóvel oferecido em garantia. Todo o processo — da simulação inicial até a liberação do crédito — é sujeito a análise e aprovação de crédito, e a Revla acompanha cada etapa para esclarecer dúvidas e agilizar a documentação. Veja mais detalhes na página de [empréstimo com garantia de imóvel](/consorcios/emprestimo-garantia-imovel) ou fale diretamente com [Reinaldo Masullo](/reinaldo-masullo) para uma simulação personalizada, sem compromisso.",
      },
    ],
    faq: [
      {
        question: "O que é empréstimo com garantia de imóvel?",
        answer:
          "É uma modalidade de crédito em que você oferece um imóvel próprio, quitado ou já financiado, como garantia de um contrato de empréstimo, em troca de taxas de juros menores e prazos mais longos que um crédito sem garantia. No mercado financeiro, também é chamado de home equity.",
      },
      {
        question: "Eu perco o imóvel ao contratar esse empréstimo?",
        answer:
          "Não, enquanto as parcelas forem pagas em dia. O imóvel continua sendo seu e você continua usando normalmente durante todo o contrato — a garantia só é executada em caso de inadimplência prolongada.",
      },
      {
        question:
          "O dinheiro liberado tem que ser usado para comprar outro imóvel?",
        answer:
          "Não. Ao contrário do financiamento imobiliário, o valor liberado no empréstimo com garantia de imóvel pode ser usado livremente, para qualquer finalidade — quitar dívidas, investir, reformar ou outro objetivo.",
      },
      {
        question: "Preciso de análise de crédito para contratar?",
        answer:
          "Sim. Como em qualquer operação de crédito, a contratação é sujeita a análise e aprovação de crédito pela instituição financeira parceira, além da avaliação formal do imóvel oferecido em garantia.",
      },
      {
        question: "A Revla empresta o dinheiro diretamente?",
        answer:
